...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private Button btnFindPath,btncurrent;
...
//                .position(hcmus)));
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            LatLng lcurrent = new LatLng(mLastLocation.getLatitude(),mLastLocation.getLongitude());
            CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(lcurrent,18);
